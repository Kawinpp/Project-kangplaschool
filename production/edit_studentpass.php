...
if (!$_SESSION["a_id"]) {
  ...
  $sqlstd = "SELECT * FROM student WHERE std_id=$std_id";
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                  <br />
									<form method="POST" action="update_studentpass.php" class="form-horizontal form-label-left">
                                    <input type="hidden" value="<?php echo $rowstd["std_id"]; ?>" name="std_id">
                                    <div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="std_password">ชื่อเข้าระบบ<span class="required">*</span>
											</label>
                                            
                                            <label class="col-form-label col-md-3 col-sm-3" for="a_password">
                                            <b><?php echo $rowstd["std_username"]; ?></b>
		
</label>
										</div>	<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="std_password">รหัสผ่านใหม่<span class="required">*</span>
											</label>
