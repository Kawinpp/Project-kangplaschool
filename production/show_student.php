...
<link href="../vendors/datatables.net-bs/css/dataTables.bootstrap.min.css" rel="stylesheet">
 ...
 <?php include"menu_left.php";?>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>แสดงข้อมูลนักเรียนทั้งหมด</h3>
              </div>
              ...
              <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <?php 
                          $sqlclassroom = "SELECT * FROM classroom ORDER BY c_name DESC"; //เลือกข้อมูลจากตาราง admin ออกมาแสดง
        ...
        ?>
				<a href="detail_class.php?c_id=<?php echo $rowclassroom["c_id"] ?>" class="btn btn-success btn-sm"> <?php echo $rowclassroom["c_name"] ?></a>&nbsp;
                          <?php } ?>                       
                    </ul>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                  <?php
$sqlstd = "SELECT * FROM student inner join admin on student.a_id=admin.a_id inner join classroom on student.c_id=classroom.c_id"; //เลือกข้อมูลจากตาราง admin ออกมาแสดง
